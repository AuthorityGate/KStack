# QC round 18: dedicated exit code — closing Opus's three round-17 questions
...
You are reviewing round 18 independently. You have not seen any other
reviewer's output for this round. Production code is unchanged since round
8. What's new this round is the closing evidence for all three of Opus's
round-17 unresolvedQuestions: the audit-reason-string consumer search
(confirming no live code reads persisted `audit[].reason`), the exact exit
