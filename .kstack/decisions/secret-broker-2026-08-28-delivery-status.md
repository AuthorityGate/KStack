...
| Active delivery item | `SB-WP03` / Jira KSTK-135 — R11 `revise/99` remaining same-realm Buffer conversion/comparison, integer, trusted-time, and array lookup/transformation mutation paths repaired with captured intrinsic dispatch and indexed private copies; regressions prove canonical validation, expiry, stale-snapshot, unrelated-head, and deterministic-transform fences; exact focused 57/57, architecture 9/9, and full 1,063 tests with zero failures; exact-candidate R12 pending |
