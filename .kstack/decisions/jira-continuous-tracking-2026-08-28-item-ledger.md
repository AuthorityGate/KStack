...
|---|---|---|---|
| JT-TC01 | Initial roadmap preview, create/adopt, read-back, and reconciliation | `IMPLEMENTED-UNDER-TEST` | Default five-item and custom manifest path exists. Complete adversarial and integrity tests before review. |
