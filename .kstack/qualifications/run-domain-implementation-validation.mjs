...
const rows = inventory.map((row) => ({
  ...
  validationReceiptDigest: recordDigest({ itemId: row.itemId, testExecutionDigest, validationFiles: row.validationFiles }),
  implemented: true,
  current: passed,
  qualified: false,
  activated: false
...
const report = {
  ...
  testExecutionDigest, rows, aggregate: passed ? 'PASS' : 'FAIL'
};
